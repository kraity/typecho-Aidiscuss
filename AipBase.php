...
class AipBase
{
    ...
    public static function getInstance()
    {
        if (self::$instance == null) {
            $option = Typecho_Widget::widget('Widget_Options')->plugin("Aidiscuss");
...
//        @file_put_contents($this->getAuthFilePath(), json_encode($obj));
        ...
        $arr = unserialize(Typecho_Widget::widget('Widget_Options')->__get('plugin:Aidiscuss'));
        $arr['authObj'] = json_encode($obj);
        Helper::configPlugin("Aidiscuss", $arr);
    }
...
//        if ($content !== false) {
        $content = Typecho_Widget::widget('Widget_Options')->plugin("Aidiscuss")->authObj;
